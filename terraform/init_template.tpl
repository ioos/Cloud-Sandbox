...
# Do manually for RHEL 10 for now
...
echo "Manually run this for now"
echo "========================="
echo "mount -t efs ${efs_name}:/ /mnt/efs/fs1"
echo "echo \"${efs_name}:/ /mnt/efs/fs1 efs defaults,_netdev 0 0\" >> /etc/fstab"
