...
export   ROMS_APPLICATION=ECCOFS
...
if [ $nl_exe -eq 1 ]; then
  ...
  echo
  export     MY_CPP_FLAGS="${MY_CPP_FLAGS} -DSPLIT_EXECUTABLE"
...
#export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DGATHER_SENDRECV"
#export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DSCATTER_BCAST"
 export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DCOLLECT_ALLREDUCE"
#export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DREDUCE_ALLGATHER"
#export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DMULTI_THREAD"
